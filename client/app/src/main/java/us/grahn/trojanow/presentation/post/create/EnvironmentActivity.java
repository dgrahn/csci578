...
/**
 * An interface which allows the user to create an environment.
 *
 * @us.grahn.class     EnvironmentInterface
 * @us.grahn.component CreatePostInterface
 * @us.grahn.tier      Presentation
 */
public class EnvironmentActivity extends ActionBarActivity {
